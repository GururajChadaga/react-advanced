...
const Body = () => {
  ...
  return isOnline ? (
    <div
      className='flex flex-col flex-grow p-4 mb-4 border border-black border-solid'
    ...
    <div data-testid='offline-container'>
      Looks like you're offline, please check your internet conenction
    </div>
  );
};
