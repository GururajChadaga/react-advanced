...
const RestaurantCard = ({ resData }) => {
  ...
  return (
    <div
      className='rounded-[2rem] m-4 w-[17rem] p-[1.125rem] max-h-96 hover:cursor-pointer hover:bg-[#f0f0f0] hover:p-1'
...
export const getTopRatedBadge = (Card) => {
  return (props) => {
    return (
      <div className='relative'>
        <label className='absolute top-6 left-5 bg-black text-white m-2 p-2 rounded-[2rem]'>
          TopRated
        </label>
        <Card {...props} />
      </div>
